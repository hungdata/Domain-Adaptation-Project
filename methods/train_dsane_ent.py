...
def main():
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        epoch_cls_loss = 0.0; epoch_lmmd_loss = 0.0; epoch_total_loss = 0.0; epoch_ent_loss = 0.0
        correct = 0; total = 0
        ...
        for src_imgs, src_labels in tqdm(src_train_loader, desc=f'Epoch [{epoch:03d}/{args.epochs}]', leave=False, dynamic_ncols=True):
            ...
            if lambda_p <= 0.0:
                ...
                total_loss = cls_loss + lambda_p * lmmd_loss + lambda_p * args.ent_weight * ent_loss
        ...
        losses = {"total": epoch_total_loss, "cls": epoch_cls_loss, "domain": 0.0, "lmmd": epoch_lmmd_loss, "ent_min": epoch_ent_loss}
        ...
        append_csv(epoch_log_path, {
            ...
            "mcc_loss": "0", "entropy_weight_mean": f"{args.ent_weight}",
