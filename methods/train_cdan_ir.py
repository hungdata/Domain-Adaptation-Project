...
def main():
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        epoch_cls_loss = 0.0; epoch_aux_domain_loss = 0.0; epoch_ir_weight = 0.0; epoch_domain_loss = 0.0; epoch_total_loss = 0.0
        correct = 0; total = 0
        ...
        append_csv(epoch_log_path, {
            ...
            "source_cls_loss": f"{epoch_cls_loss:.6f}", "domain_loss": f"{epoch_domain_loss:.6f}", "lmmd_loss": "0", "mcc_loss": "0", "entropy_weight_mean": f"{epoch_ir_weight:.4f}",
