...
from core.uda_utils import (
    ...
    FeatureExtractor, Bottleneck, ClassifierHead, DomainDiscriminator, compute_lmmd,
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        append_csv(epoch_log_path, {
            ...
            "source_cls_loss": f"{epoch_cls_loss:.6f}", "domain_loss": f"{epoch_aux_domain_loss:.6f}", "lmmd_loss": f"{epoch_lmmd_loss:.6f}", "mcc_loss": "0", "entropy_weight_mean": f"{epoch_ir_weight:.4f}",
