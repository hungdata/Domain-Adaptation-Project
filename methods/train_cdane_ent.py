    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        for src_imgs, src_labels in tqdm(src_train_loader, desc=f'Epoch [{epoch:03d}/{args.epochs}]', leave=False, dynamic_ncols=True):
            ...
            if lambda_p <= 0.0:
                ...
                ent_loss = entropy_of(F.softmax(tgt_logits, dim=1)).mean()
                total_loss = cls_loss + domain_loss + lambda_p * args.ent_weight * ent_loss
            ...
            epoch_ent_loss    += ent_loss.item() * bs
        ...
        losses = {"total": epoch_total_loss, "cls": epoch_cls_loss, "domain": epoch_domain_loss, "lmmd": 0.0, "ent_min": epoch_ent_loss}
        ...
        append_csv(epoch_log_path, {
            ...
            "source_cls_loss": f"{epoch_cls_loss:.6f}", "domain_loss": f"{epoch_domain_loss:.6f}", "lmmd_loss": "0", "mcc_loss": "0", "entropy_weight_mean": f"{epoch_entropy_weight:.6f}",
