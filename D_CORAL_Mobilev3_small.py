...
# =========================================================
# D-CORAL Loss
# Align covariance giữa source feature và target feature
# =========================================================
...
# =========================================================
# MobileNetV3 Small + D-CORAL
# =========================================================
class DCORALMobileV3Small(nn.Module):
...
model = DCORALMobileV3Small(num_classes=2).to(device)
...
for epoch in range(EPOCHS):
    ...
    for (x_s, y_s), (x_t, _) in loop:
        ...
        # Total loss
        # =========================
        loss = loss_class + CORAL_WEIGHT * loss_coral
    ...
    avg_coral_loss = total_coral_loss / total_batches
    ...
    print(f"Train coral loss : {avg_coral_loss:.8f}")
    ...
    if mean_entropy < best_entropy - min_delta:
        ...
        best_model_path = (
            f"DCORAL_MobileV3Small_best_entropy_"
